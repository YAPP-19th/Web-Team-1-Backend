...
.request
include::{snippets}/quests/position/count/get/http-request.adoc[]
.response
include::{snippets}/quests/position/count/get/http-response.adoc[]
.response fields
include::{snippets}/quests/position/count/get/response-fields.adoc[]
...
=== GET /api/quests/{questId}/subquest
==== 퀘스트의 서브 퀘스트 진행 현황 조회

.request
include::{snippets}/quests/subquest/get/path-parameters.adoc[]
.response
include::{snippets}/quests/subquest/get/http-response.adoc[]
.response fields
include::{snippets}/quests/subquest/get/response-fields.adoc[]
