...
=== GET /api/quests/{questId}/user-quest-status/
==== 로그인한 유저에 대한 퀘스트의 상태 정보 조회
로그인을 안했을 경우 (전송한 토큰이 없을 경우) 403(No Token Error) 발생

.request
include::{snippets}/quests/user-quest-status/get/path-parameters.adoc[]
.response
include::{snippets}/quests/user-quest-status/get/http-response.adoc[]
.response fields
include::{snippets}/quests/user-quest-status/get/response-fields.adoc[]
...
.request
include::{snippets}/quests/review/post/http-request.adoc[]
.response
include::{snippets}/quests/review/post/http-response.adoc[]
.request fields
include::{snippets}/quests/review/post/response-fields.adoc[]
.response fields
include::{snippets}/quests/review/post/response-fields.adoc[]
